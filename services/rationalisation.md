...
finds:
  - title: Dormant content
    text: Dashboards, cards and reports nobody has opened in a long time.
  - title: Duplicates
    text: Copies of the same dashboard or dataset, often with small, unexplained differences.
  - title: Conflicting metrics
    text: Several definitions of "revenue" or "active customer" producing different answers.
  - title: Orphaned data
...
{% include cards.html items=page.finds %}
