...
We try to keep the site accurate and up to date, but its content is general information, not advice for your particular situation. Figures such as automation rates and timelines describe typical engagements. Your results depend on your estate and are set out in a scoped proposal.

## Links to other *sites*

Where we link to other websites, we aren't responsible for their content or practices.

## Liability

To the extent permitted by law, we aren't liable for any loss that arises from using this site or relying on its content. Nothing in these terms limits liability that can't be limited by law.

## Changes and *governing law*

We may update these terms from time to time. The version on this page applies from the date it's published. The governing law and jurisdiction for these terms are to be confirmed.
